package com.razerdp.basepopup.extension.demo.widget;
...
import com.razerdp.basepopup.extension.demo.base.baseadapter.FixedViewInfo;
import com.razerdp.basepopup.extension.demo.base.baseadapter.HeaderViewWrapperAdapter;
import com.razerdp.basepopup.extension.demo.utils.ToolUtil;
...
import static com.razerdp.basepopup.extension.demo.base.baseadapter.FixedViewInfo.*;
...
public class DPRecyclerView extends RecyclerView {
    ...
    public void setAdapter(@Nullable Adapter adapter, AdapterDataObserver observer) {
        if (!(adapter instanceof HeaderViewWrapperAdapter) && (mHeaderViewInfos.size() > 0 || mFooterViewInfos.size() > 0)) {
            adapter = wrapHeaderRecyclerViewAdapterInternal(adapter, mHeaderViewInfos, mFooterViewInfos);
        }
    ...
    private void checkAndNotifyWrappedViewAdd(Adapter adapter, FixedViewInfo info, boolean isHeader) {
    ...
    protected HeaderViewWrapperAdapter wrapHeaderRecyclerViewAdapterInternal(@NonNull Adapter mWrappedAdapter,
