package razerdp.basepopup.extension.demo;
...
import razerdp.basepopup.extension.demo.base.baseactivity.BaseActivity;
import razerdp.basepopup.extension.demo.base.baseadapter.BaseMultiRecyclerViewHolder;
import razerdp.basepopup.extension.demo.base.baseadapter.MultiRecyclerViewAdapter;
import razerdp.basepopup.extension.demo.base.baseadapter.MultiType;
import razerdp.basepopup.extension.demo.base.baseadapter.OnItemClickListener;
import razerdp.basepopup.extension.demo.fun.FunContent;
import razerdp.basepopup.extension.demo.fun.FunTitle;
import razerdp.basepopup.extension.demo.fun.alert.FunIosAlert;
import razerdp.basepopup.extension.demo.fun.alert.FunMaterialAlert;
import razerdp.basepopup.extension.demo.utils.ButterKnifeUtil;
import razerdp.basepopup.extension.demo.utils.UIHelper;
import razerdp.basepopup.extension.demo.widget.DPRecyclerView;
import razerdp.basepopup.extension.demo.widget.DPTextView;
import razerdp.basepopup.extension.demo.widget.decoration.GridItemDecoration;
import razerdp.basepopup.extension.demo.widget.decoration.SpaceOption;
...
public class DemoActivity extends BaseActivity {
    ...
    private List<MultiType> createItem() {
        ...
        result.add(new FunMaterialAlert());
